# Hephaitos API 엔드포인트 상세 스펙

**버전**: v1.0.0  
**Base URL**: `https://api.hephaitos.io/api/v1`  
**인증**: Bearer JWT Token
...
Response: 201 Created
{
  ...
  "url": "https://hephaitos-storage.s3.amazonaws.com/documents/uuid.pdf"
}
...
{
  "status": "completed",
  "pdfUrl": "https://hephaitos-storage.s3.amazonaws.com/applications/uuid.pdf"
}
```
